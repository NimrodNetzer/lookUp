export default function CosmicBg({ variant = "default" }) {
  const dark = variant === "dark";
  const o = (base) => dark ? base * 0.38 : base;
  ...
  return (
    <div
      ...
      style={{
        ...
        pointerEvents:"none",background:baseBg,
      }}
    >
      <svg
      ...
      >
        ...
        <path d={WAVE} fill="none" stroke="url(#cbWave)" strokeWidth="160" strokeOpacity={dark ? o(0.09) : 0.045} strokeLinecap="round" filter="url(#cbRibbonGlow)" />
        <path d={WAVE} fill="none" stroke="url(#cbWave)" strokeWidth="80"  strokeOpacity={dark ? o(0.13) : 0.065} strokeLinecap="round" />
        <path d={WAVE} fill="none" stroke="url(#cbWave)" strokeWidth="30"  strokeOpacity={dark ? o(0.22) : 0.11} strokeLinecap="round" />
        <path d={WAVE} fill="none" stroke="url(#cbWave)" strokeWidth="2.5" strokeLinecap="round" strokeOpacity={dark ? 0.55 : 0.5} filter="url(#cbGlow)" />
        ...
        {dots.slice(0,-1).map(([x1,y1],i) => {
          ...
          return <line key={i} x1={x1} y1={y1} x2={x2} y2={y2} stroke={`rgba(120,100,230,${o(0.12)})`} strokeWidth="0.8" />;
        })}
      </svg>
    </div>
  );
